...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResultTable.use_age_group'
        db.add_column(u'windberg_results_resulttable', 'use_age_group',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ResultTable.use_gender'
        db.add_column(u'windberg_results_resulttable', 'use_gender',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResultTable.use_age_group'
        db.delete_column(u'windberg_results_resulttable', 'use_age_group')

        # Deleting field 'ResultTable.use_gender'
        db.delete_column(u'windberg_results_resulttable', 'use_gender')
