...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResultEntry.result_time'
        db.add_column(u'windberg_results_resultentry', 'result_time',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2013, 10, 31, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResultEntry.result_time'
        db.delete_column(u'windberg_results_resultentry', 'result_time')
