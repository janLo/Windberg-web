...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResultEntry.rank_sex'
        db.add_column(u'windberg_results_resultentry', 'rank_sex',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResultEntry.rank_sex'
        db.delete_column(u'windberg_results_resultentry', 'rank_sex')
