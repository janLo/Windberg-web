...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ResultEntry.birth_year'
        db.alter_column(u'windberg_results_resultentry', 'birth_year', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'ResultEntry.birth_year'
        db.alter_column(u'windberg_results_resultentry', 'birth_year', self.gf('django.db.models.fields.DateField')(default=0))
    ...
    models = {
        ...
        u'windberg_results.resultentry': {
            ...
            'rank_sex': ('django.db.models.fields.IntegerField', [], {}),
