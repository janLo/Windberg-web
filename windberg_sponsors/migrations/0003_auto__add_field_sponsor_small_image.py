...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sponsor.small_image'
        db.add_column(u'windberg_sponsors_sponsor', 'small_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sponsor.small_image'
        db.delete_column(u'windberg_sponsors_sponsor', 'small_image')
    ...
    models = {
        ...
        u'windberg_sponsors.categoryplugin': {
            'Meta': {'object_name': 'CategoryPlugin', 'db_table': "u'cmsplugin_categoryplugin'", '_ormbases': ['cms.CMSPlugin']},
