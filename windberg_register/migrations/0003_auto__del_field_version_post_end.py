...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Version.post_end'
        db.delete_column(u'windberg_register_version', 'post_end')


    def backwards(self, orm):
        # Adding field 'Version.post_end'
        db.add_column(u'windberg_register_version', 'post_end',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 4, 0, 0), auto_now=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'windberg_register.version': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'net_end': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
